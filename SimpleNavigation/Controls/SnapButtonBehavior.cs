...
namespace SimpleNavigation.Controls;
...
public class SnapButtonBehavior : Behavior<ButtonBase>
{
    ...
    public static readonly DependencyProperty SnapTypeProperty =
        DependencyProperty.Register("SnapType", typeof(ButtonContentSnapType), typeof(SnapButtonBehavior), new PropertyMetadata(ButtonContentSnapType.None, (s, a) =>
        {
